...
from gws_core import (FloatParam, InputSpec, IntParam, OutputSpec,
                      StrParam, TaskInputs, TaskOutputs, task_decorator, ConfigParams, ConfigSpecs, InputSpec, OutputSpec, InputSpecs, OutputSpecs)
...
class GmapAlignGTF(BaseOmixEnvTask):
    ...
    input_specs: InputSpecs = {
        ...
        'cdna_or_cds_fasta_file': InputSpec(FastaFile, human_name="", short_description="")
    }
    output_specs: OutputSpecs = {
        'gmap_gtf_file': OutputSpec(GTFFile, human_name="", short_description="")
    }
    ...
    def build_command(self, params: ConfigParams, inputs: TaskInputs) -> list:
        ...
        cmd = [
            "bash",
            os.path.join(script_file_dir, "./sh/gmap_gtf_cmd.sh"),
            thread,
            idt,
            cov,
            hit_nbr,
