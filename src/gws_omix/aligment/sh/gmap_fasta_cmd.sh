...
$mapping_tool $crsSpecies $altStart $fullLght -t $threadNbr -f 2 --npaths $hitNbr --min-identity $idt --min-trimmed-coverage $cov -D $genome_dir -d $genome_index_name $fastaFile | grep -v "^# Generated by GMAP" > tmp.gff3 ;
