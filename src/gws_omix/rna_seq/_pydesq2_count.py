...
class DeseqAnalyzer:
    def __init__(self, count_table_path, metadata_path, genes_colname, control_condition=None, unnormal_condition=None, padj_value=None, log2FoldChange_value=None):
    ...
    def save_pca_proportions(self):
        ...
        pca_proportions_df = pd.DataFrame({'PC1 Proportion': [pca_proportions[0]], 'PC2 Proportion': [pca_proportions[1]]})

        # Save PCA proportions
    ...
    def generate_clustermap(self):
        ...
        # Save the clustermap as a PNG file
        clustermap.savefig('Heatmap.png')

    def generate_volcano_plot(self):
        # Assuming 'res' is the result dataframe
    ...
    def run_analysis(self):
        ...
        self.save_desq2_results_table()  # Save significant genes to CSV
...
deseq_analyzer = DeseqAnalyzer(
    count_table_file, metadata_file,
