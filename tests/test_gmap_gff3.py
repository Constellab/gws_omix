...
class TestGmapGFF3(BaseTestCase):
    ...
    async def test_GmapGFF3(self):
        ...
        # Running BlastEC.py
        tester = TaskTester(
            params = {"threads": 2, "min-identity":0.0, "min-trimmed-coverage": 0.0, "max-hit-number":5, "cross-species":"No", "alt-start-codons":"No", "fulllength":"No" },
        ...
        expected_file_path = os.path.join(data_dir, "test.gmap.fasta.fna.gff3")
